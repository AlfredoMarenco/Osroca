    ...
    <section id="modelos">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 bg-aqua uno-uno padding-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 modelo-car-2">
                            <img src="{{ asset('img/Icons/Icon-Baño-mdo.png') }}" alt="" class="img-fluid caract-mod-1-1">
        ...
        <div class="container">
            ...
            <div class="row magenta-model">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 padding-0 imagen">
                    <img src="{{ asset('img/violeta-plus/GC_Violeta_Plus_Fachada-2.jpg') }}" class="img-fluid" alt="">
                </div>
            </div>
    </section>
